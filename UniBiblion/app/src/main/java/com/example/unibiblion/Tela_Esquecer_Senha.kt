...
class Tela_Esquecer_Senha : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ID do EditText: edit_text_email_recover
        // ID do Button: button_send_code
        ...
        auth.sendPasswordResetEmail(email)
            .addOnCompleteListener { task ->
                ...
                if (task.isSuccessful) {
                    // Feedback positivo e seguro: informa que as instruções foram enviadas.
                    ...
                    // Retorna para a tela de Login ou fecha esta tela.
                    finish()
                } else {
                    // Feedback de falha (conexão ou Firebase)
